...
public class MainActivity extends AppCompatActivity {
    ...
    EditText editTextName, editTextAddress, editTextNumber, editTextEmail;
    ...
    private void findViews() {
        ...
        editTextNumber = (EditText) findViewById(R.id.edit_phoneNumber);
        editTextEmail = (EditText) findViewById(R.id.edit_email);
        listViewDeliveries = (ListView) findViewById(R.id.listViewDeliverys);
        buttonAddUser = (Button) findViewById(R.id.buttonCreate);
        buttonEditOption = (Button) findViewById(R.id.buttonEditOption);
